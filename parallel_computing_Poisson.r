...
parallel.computing <- function(n, n_sim, detection.switch, 
  ...
  for(i in 1:n_sim){
    ...
    dec.list[[i]] <- as.matrix(read.csv(paste0("SN", i, "_", perturb.type,"_","Y",(l1/n*100),"N",y.perturb, 
                                               "_","X", round(l2/n*100), "N", x.perturb,"_",X.type,"_dec.csv")))[,-1]
    time.mat[i,] <- as.matrix(read.csv(paste0("SN", i, "_", perturb.type,"_","Y",(l1/n*100),"N",y.perturb, 
                                              "_","X", round(l2/n*100), "N", x.perturb,"_",X.type,"_time.csv")))[,-1]
    #Y.mat[i,] <- as.matrix(read.csv(paste0("SN", i, "_", perturb.type,"_","Y",(l1/n*100),"N",y.perturb, 
    #                                       "_","X", round(l2/n*100), "N", x.perturb,"_",X.type,"_Y.csv")))[,-1]
  }
